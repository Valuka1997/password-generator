...
numbers = IntVar()
special = IntVar()
C1 = Checkbutton(ui, text="Letters", variable=letters, onvalue=1,
                 offvalue=0, height=5, width=20, command=chckd)
C2 = Checkbutton(ui, text="Numbers", variable=numbers, onvalue=1,
                 offvalue=0, height=5, width=20, command=chckd)
C3 = Checkbutton(ui, text="Special Characters", variable=special,
                 onvalue=1, offvalue=0, height=5, width=20, command=chckd)
...
generate_password_button = Button(ui, text="Check at least one option!",
                                  state=DISABLED, bg="#fb743e", height=4, width=55, command=pw_gen)
